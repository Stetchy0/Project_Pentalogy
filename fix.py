...
print("Executing Deep Clean Slate Override Pass...")
...
# FORCE WIPE: Completely delete the old folder to strip any extensionless ghost files away
if os.path.exists(output_dir):
    try:
        shutil.rmtree(output_dir)
        print(" -> Cleaned historic output directories successfully.")
    except Exception:
        pass
...
for file in character_files:
    ...
    if not image_slides_html:
        image_slides_html = '<div class="mySlides fade" style="display:block; color:#2b1e13; padding: 20px;"><p>No archive gallery items uploaded.</p></div>'
...
<div class="sidebar">
  ...
  <ul style="padding-left:15px; line-height:1.8; list-style-type: none;">
    {sidebar_links_html}
  </ul>
</div>
...
# Generate a pristine master home screen index page cleanly appended with the .html suffix extensions
first_file_name = sorted(character_files)[0]
first_char_key = os.path.splitext(first_file_name)[0].lower()
